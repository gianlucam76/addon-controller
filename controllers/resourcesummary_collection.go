...
func collectResourceSummariesFromCluster(ctx context.Context, c client.Client, cluster *corev1.ObjectReference,
	...
	// If agent is running in the management cluster or cluster is in pull mode, the resourceSummaries for this cluster
	// are in the cluster namespace and have very specific labels
